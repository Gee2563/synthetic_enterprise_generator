...
EXPECTED_MODULES = [
    ...
    "synthetic_enterprise.evaluation.comparison",
    "synthetic_enterprise.evaluation.quality_report",
    "synthetic_enterprise.evaluation.regression",
    ...
    "synthetic_enterprise.generation.account_profiles",
    "synthetic_enterprise.generation.cross_system",
    "synthetic_enterprise.generation.hard_negatives",
    "synthetic_enterprise.generation.language_profiles",
    "synthetic_enterprise.generation.personas",
    ...
    "synthetic_enterprise.sources.email.composition",
    "synthetic_enterprise.sources.email.paraphrases",
